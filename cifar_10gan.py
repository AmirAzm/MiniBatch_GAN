...
Original file is located at
    https://colab.research.google.com/drive/1p_MxTPAX1BkqZAUYZblFlVQyN0kIPaKr
"""
...
train(generator, discriminator, combined,epochs=50, batch_size=128, save_interval=1)
